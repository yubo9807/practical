var me=Object.defineProperty;var pe=(e,r,n)=>r in e?me(e,r,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[r]=n;var y=(e,r,n)=>(pe(e,typeof r!="symbol"?r+"":r,n),n),J=(e,r,n)=>{if(!r.has(e))throw TypeError("Cannot "+n)};var m=(e,r,n)=>(J(e,r,"read from private field"),n?n.call(e):r.get(e)),A=(e,r,n)=>{if(r.has(e))throw TypeError("Cannot add the same private member more than once");r instanceof WeakSet?r.add(e):r.set(e,n)},_=(e,r,n,t)=>(J(e,r,"write to private field"),t?t.call(e,n):r.set(e,n),n);var ee=(e,r,n,t)=>({set _(o){_(e,r,o,n)},get _(){return m(e,r,t)}});import{p as de}from"./@babel-228ab864.js";import{j as Y,u as q,b as re,a as E,c as ne,h as b,l as fe,L as ge}from"./pl-react-491477f1.js";import{e as he,_ as ye,a as be,b as xe,d as ve,f as _e,h as we,s as ke,j as Te,k as Se,l as Ce}from"./index-cbd910c8.js";import{D as je}from"./basic-596bbc4d.js";import{r as Ae,_ as Le,a as Pe,b as Me}from"./async-abb0497e.js";import{_ as Ee}from"./math-c1d85691.js";import{f as Oe,a as Re,t as Fe}from"./source-1ce25409.js";import"./debug-ddf39923.js";import"./ms-f6814399.js";import"./globals-aa9f7777.js";import"./@jridgewell-b3e211dc.js";import"./jsesc-4cfd8464.js";import"./picocolors-cddfbdbe.js";import"./js-tokens-bc2e8ff2.js";import"./marked-4b92e03d.js";const De="page-utils-f86c23",Be="navigation-62969b",Ne="content-bea58d",Ie="outline-690e4e",Ue="total-307071",N={"page-utils":"page-utils-f86c23",pageUtils:De,navigation:Be,content:Ne,outline:Ie,total:Ue},We=`import { randomNum } from './number';\r
...
// resolvePath('/path/to', './a/b/c');  //--> "/path/to/a/b/c"`,ir=`
/**
 * HTML 转 AST 语法树
 * @param html
 * @returns 返回 AST 语法树
...
// removeXMLTag('<div class="wrap">hello world</div>'); // hello world`;function lr(e){let r=null;return new Proxy(e,{construct(n,t){return r||(r=new n(...t)),r}})}const cr=Object.freeze(Object.defineProperty({__proto__:null,singleton:lr},Symbol.toStringTag,{value:"Module"}));function ur(e="000000",r="ffffff"){const n=parseInt(e,16),t=parseInt(r,16);return"#"+Ae(t,n).toString(16)}function mr(e){const r=e.replace("#",""),n=parseInt(r.substring(0,2),16),t=parseInt(r.substring(2,4),16),o=parseInt(r.substring(4,6),16);return`${n}, ${t}, ${o}`}function pr(e,r,n){return .2126*e+.7152*r+.0722*n}function dr(e,r,n){const t=(r[0]-e[0])/n,o=(r[1]-e[1])/n,a=(r[2]-e[2])/n,s=[];for(let i=0;i<n;i++)s.push([Math.round(e[0]+i*t),Math.round(e[1]+i*o),Math.round(e[2]+i*a)]);return s}function fr(e,r){if(!/^#[0-9A-F]{6}$/i.test(e)||!/^#[0-9A-F]{6}$/i.test(r))throw new Error("Invalid hex color format");const n=parseInt(e.slice(1),16),t=parseInt(r.slice(1),16),o=Math.floor((n>>16)+(t>>16))/2,a=Math.floor((n>>8&255)+(t>>8&255))/2,s=Math.floor((n&255)+(t&255))/2;return`#${(o<<16|a<<8|s).toString(16).padStart(6,"0")}`}const gr=Object.freeze(Object.defineProperty({__proto__:null,colorToRGB:mr,getMiddleColorList:dr,grayColor:pr,mergeColor:fr,randomColor:ur},Symbol.toStringTag,{value:"Module"}));function hr(e){return e.getDay()%6!==0}function yr(e){return e.toTimeString().slice(0,8)}function te(e){let r=e||e===0?new Date(e):new Date;return{year:r.getFullYear()+"",month:r.getMonth()+1,day:r.getDate(),hour:r.getHours(),minute:r.getMinutes(),second:r.getSeconds()}}function br(e=new Date,r="YYYY-MM-DD hh:mm:ss"){const{year:n,month:t,day:o,hour:a,minute:s,second:i}=te(e);return r.replace(/YYYY/g,n).replace(/YY/g,n.substr(2,2)).replace(/MM/g,(t<10?"0":"")+t).replace(/DD/g,(o<10?"0":"")+o).replace(/hh/g,(a<10?"0":"")+a).replace(/mm/g,(s<10?"0":"")+s).replace(/ss/g,(i<10?"0":"")+i)}const I=e=>e<10?"0"+e:e;function xr(e){const r=new Date(e),n=r.getFullYear(),t=r.getMonth()+1,o=r.getDate(),a=r.getHours(),s=r.getMinutes(),i=r.getSeconds();return`${n}-${I(t)}-${I(o)} ${I(a)}:${I(s)}:${I(i)}`}const vr={day:0,hours:0,minute:0,second:0};function z(e=0,r=vr){if(e<60)r.second=e;else if(e<3600){const t=Math.floor(e/60),o=e-60*t;r.minute=t,o>0&&z(o,r)}else if(e<3600*24){const t=Math.floor(e/3600),o=e-3600*t;r.hours=t,o>0&&z(o,r)}else{const t=Math.floor(e/86400),o=e-86400*t;r.day=t,o>0&&z(o,r)}return r}function _r(e=new Date){return new Date(e.toDateString()).getTime()}const wr=Object.freeze(Object.defineProperty({__proto__:null,dateFormater:br,getCurrentDate:te,getDateTime:yr,getNowDayZeroTimestamp:_r,getTimeDistance:z,isWeekday:hr,switchTimeFormat:xr},Symbol.toStringTag,{value:"Module"}));function kr(e,r){class n extends HTMLElement{constructor(){super();const o=this.attachShadow({mode:"open"}),a=document.createElement("template");if(typeof r=="string")a.innerHTML=r,o.appendChild(a.content.cloneNode(!0));else{a.appendChild(r);for(const s of a.childNodes)o.appendChild(s)}}}customElements.define(e,n)}function Tr(e){return e===document.activeElement}function Sr(e){var r=document.createElement("div");r.appendChild(e.cloneNode(!0));var n=r.innerHTML;return r=e=null,n}function Cr(e,r){for(;e&&r;)e=e.parentElement,r--;return e}function jr(e,r){for(;e&&r;)if(r>0){if(e.nextElementSibling)e=e.nextElementSibling;else for(e.nextSibling;e&&e.nextSibling!=1;e=e.nextSibling);r--}else{if(e.previousElementSibling)e=e.previousElementSibling;else for(e.previousSibling;e&&e.previousSibling!=1;e=e.previousSibling);r++}return e}const Ar=(e,r)=>window.getComputedStyle?window.getComputedStyle(e,null)[r]:e.style[r];function Lr(e){e=e||window.event,e.stopPropagation?e.stopPropagation():e.cancelBubble=!0}function Pr(e,r){if(X(e,r))return;let n=e.className.split(" ");n.push(r),e.className=n.join(" ")}function Mr(e,r){if(!X(e,r))return;let n=new RegExp("(^|\\s)"+r+"(\\s|$)","g");e.className=e.className.replace(n," ")}function X(e,r){return new RegExp("(^|\\s)"+r+"(\\s|$)").test(e.className)}function Er(e){e=e||window.event,e.preventDefault?e.preventDefault():e.returnValue=!1}function Or(e,r){e.addEventListener("mousedown",function(n){var t=n.clientX-e.offsetLeft,o=n.clientY-e.offsetTop;window.addEventListener("mousemove",a,!1),window.addEventListener("mouseup",()=>{window.removeEventListener("mousemove",a,!1)},!1);function a(s){e.style.left=s.clientX-t+"px",e.style.top=s.clientY-o+"px",r!==void 0&&(parseFloat(e.style.top)<r.offsetTop&&(e.style.top=r.offsetTop+"px"),parseFloat(e.style.left)<r.offsetLeft&&(e.style.left=r.offsetLeft+"px"),parseFloat(e.style.left+e.clientWidth)>r.offsetLeft+r.clientWidth-parseFloat(e.clientWidth+"")&&(e.style.left=r.offsetLeft+r.clientWidth-parseFloat(e.clientWidth+"")+"px"),parseFloat(e.style.top+e.clientHeight)>r.offsetTop+r.clientHeight-parseFloat(e.clientHeight+"")&&(e.style.top=r.offsetTop+r.clientHeight-parseFloat(e.clientHeight+"")+"px"))}},!1)}const Rr=Object.freeze(Object.defineProperty({__proto__:null,addClass:Pr,cancelHandler:Er,createTemplate:kr,elementIsInFocus:Tr,getStyle:Ar,hasClassName:X,lookupParent:Cr,mouseDrag:Or,nodeToString:Sr,removeClass:Mr,retSibling:jr,stopBubble:Lr},Symbol.toStringTag,{value:"Module"}));function Fr(e){const r=new Uint8Array(e.match(/.{1,2}/g).map(t=>parseInt(t,16)));let n="";for(let t of r)n+=String.fromCharCode(t);return btoa(n)}function Dr(e){const r=e.replace(/=/g,""),n=atob(r),t=new Uint8Array(n.length);for(let a=0;a<n.length;a++)t[a]=n.charCodeAt(a);let o="";for(let a=0;a<t.length;a++){const i=t[a].toString(16).padStart(2,"0");o+=i}return o}function Br(e){for(var r="",n=new Uint8Array(e),t=n.byteLength,o=0;o<t;o++)r+=String.fromCharCode(n[o]);return btoa(r)}function Nr(e){const r=new FileReader;return new Promise((n,t)=>{r.readAsDataURL(e),r.addEventListener("load",o=>{n(o.target.result)})})}function Ir(e,r="filename",n="image/jpg"){for(var t=e.split(","),o=atob(t[1]),a=o.length,s=new Uint8Array(a);a--;)s[a]=o.charCodeAt(a);return new File([s],r,{type:n})}function Ur(e){const r=atob(e),n=new Uint8Array(r.length);for(let o=0;o<r.length;o++)n[o]=r.charCodeAt(o);const t=new Blob([n]);return URL.createObjectURL(t)}const Wr=Object.freeze(Object.defineProperty({__proto__:null,base64ToHex:Dr,base64ToUrl:Ur,base64toFile:Ir,bufferToBase64:Br,fileToBase64:Nr,hexToBase64:Fr},Symbol.toStringTag,{value:"Module"}));function Hr(e){return URL.createObjectURL(e)}function qr(e,r){const n=document.createElement("a");n.href=e,n.download=r,n.click(),n.remove()}function zr(e,r=1024*1024*5){return new Promise(async n=>{const t=Math.ceil(e.size/r),a=he(`
function createChunk(file, index, chunkSize) {
  return new Promise(resovle => {
    const start = index * chunkSize;
    const end = start + chunkSize;
...
`);a.postMessage({file:e,chunkSize:r,start:0,end:t}),a.onmessage=s=>{a.terminate(),n(s.data)}})}const $r=Object.freeze(Object.defineProperty({__proto__:null,downloadFile:qr,fileFragment:zr,fileToUrl:Hr},Symbol.toStringTag,{value:"Module"}));async function Yr(e,r={}){const n=e.match(/image\/.+;/)[0].slice(6,-1).toLocaleLowerCase();r=Object.assign({ratio:.8,sizeLimit:{width:800,height:800},rigid:!0},r);const t=new Image;return t.src=e,new Promise((o,a)=>{t.addEventListener("load",async s=>{const{naturalWidth:i,naturalHeight:c}=t;let p=0,u=0,d=0;const{sizeLimit:f}=r;f?(p=f.width,u=f.height,i>c&&(i>p?(d=i/p,u=c/d):(d=c/u,p=i/d)),c>i&&(c>u?(d=c/u,p=i/d):(d=i/p,u=c/d)),i<p&&c<u&&(p=i,u=c)):(p=i,u=c);const h=document.createElement("canvas");h.width=p,h.height=u,h.style.visibility="hidden",document.body.appendChild(h);const w=h.getContext("2d");w.clearRect(0,0,p,u),w.drawImage(t,0,0,p,u);const j=h.toDataURL(`image/${n}`,r.ratio),P=e.length>j.length?j:e;return h.remove(),console.log(e.length,j.length),o(P)})})}const Kr=Object.freeze(Object.defineProperty({__proto__:null,imageCompress:Yr},Symbol.toStringTag,{value:"Module"}));function Vr(e=1e3){setTimeout(()=>{console.log("long time fun ...")},0)}function Xr(e,r){let n=0;return function(...t){let o=new Date().getTime();o-n>r&&(e.apply(this,...t),n=o)}}function Gr(e,r){let n=null;return function(...t){let o=this;clearTimeout(n),n=setTimeout(function(){e.apply(o,...t)},r)}}function oe(e,...r){return function(...n){const t=[...r,...n];return t.length>=e.length?e.apply(this,t):oe(e,...t)}}function ae(e,r){if(!e.length)return;let n=0;function t(){r(o=>{for(;n<e.length&&o();)e[n++]();n<e.length&&t()})}t()}function Qr(e){return ae(e,r=>{requestIdleCallback(n=>{r(()=>n.timeRemaining()>0)})})}function Zr(e,r,n){const t=document.createElement("script");t.src=e,r&&(t.onload=r),n&&(t.type="module"),t.async=!0,document.body.appendChild(t)}window.addEventListener("load",()=>{setTimeout(()=>{const e=window.performance.timing,r={},n=window.performance.getEntriesByType("paint");r.DNS查询耗时=e.domainLookupEnd-e.domainLookupStart,r.TCP链接耗时=e.connectEnd-e.connectStart,r.request耗时=e.responseEnd-e.responseStart,r.解析DOM树耗时=e.domComplete-e.domInteractive,r.白屏时间=e.domLoading-e.fetchStart,r.domready=e.domContentLoadedEventEnd-e.fetchStart,r.onload=e.loadEventEnd-e.fetchStart,r["首次绘制时间(FC)"]=n[0].startTime,r["首次内容绘制时间(FCP)"]=n[1].startTime,console.log(r)},0)});window.onerror=(e,r,n,t,o)=>{let a=o?o.stack:null;console.log(e,r,n,t,a)};window.onunhandledrejection=e=>{let r="",n="";typeof e.reason=="object"?(r=e.reason.message,n=e.reason.stack):r=e.reason,console.log(r,n)};const Jr=Object.freeze(Object.defineProperty({__proto__:null,choke:Vr,currying:oe,debounce:Gr,idlePerformTask:Qr,loadScript:Zr,performTask:ae,throttle:Xr},Symbol.toStringTag,{value:"Module"}));class G{constructor(r=5){y(this,"_parallelCount");y(this,"_runingCount",0);y(this,"tasks",[]);this._parallelCount=r}add(r){const n=new Promise((t,o)=>{this.tasks.push({task:r,resolve:t,reject:o})});return this._run(),n}_run(){for(;this.tasks.length>this._runingCount&&this._runingCount<this._parallelCount;){const{task:r,resolve:n,reject:t}=this.tasks[this._runingCount];this._runingCount++,r().then(o=>n(o)).catch(o=>t(o)).finally(()=>{this._continue()})}}_continue(){this._parallelCount++,this._run()}}var U;class en extends G{constructor(n,t=!1){n.forEach((o,a,s)=>{a!==0&&(s[a]=o+s[a-1])});super();y(this,"_parallelCountList");y(this,"_parallelListIndex",0);y(this,"_executeCount",0);y(this,"_isAwait");A(this,U,null);this._parallelCountList=n,this._isAwait=t,_(this,U,this._run),this._run=()=>{this._parallelCount=this._parallelCountList[this._parallelListIndex],m(this,U).call(this)}}_continue(){if(this._executeCount++,this._isAwait){if(this._executeCount===this._parallelCount){this._parallelListIndex++,this._run();return}}else this._runingCount===this._parallelCount&&(this._parallelListIndex++,this._run());this._parallelCount++,this._run()}}U=new WeakMap;var W;class rn extends G{constructor(n=!0){super();A(this,W,void 0);this._parallelCount=1,_(this,W,n)}_run(){for(;this.tasks.length>this._runingCount&&this._runingCount<this._parallelCount;){const{task:n,resolve:t,reject:o}=this.tasks[this._runingCount];this._runingCount++,n().then(a=>{t(a),this._continue()}).catch(a=>{o(a),m(this,W)&&this._continue()})}}}W=new WeakMap;var F,T,S,L,D;class nn{constructor(...r){y(this,"START_FAILURE",Symbol("startFailure"));y(this,"ILLEGAL_CALL",Symbol("illegalCall"));y(this,"NOT_TASK",Symbol("notTask"));A(this,F,!1);A(this,T,!1);A(this,S,null);A(this,L,0);y(this,"start",async()=>{if(m(this,F))return console.warn("非法调用！任务队列正在执行中，无法重新执行"),Promise.reject(this.ILLEGAL_CALL);if(m(this,L)>m(this,S).length-1)return console.warn("没有任务可以继续执行"),Promise.resolve(this.NOT_TASK);_(this,F,!0),_(this,T,!0);const r=await m(this,D).call(this);return _(this,F,!1),r});A(this,D,async(r=[])=>{if(!m(this,T))return;const n=m(this,S).length;m(this,L)===n-1&&_(this,T,!1);const t=m(this,S)[m(this,L)]();return ee(this,L)._++,await t.then(async a=>await o.call(this,a)).catch(a=>(_(this,T,!1),Promise.reject(a)));async function o(a){return r.push(a),m(this,S).length>n?(_(this,T,!0),await m(this,D).call(this,r)):m(this,T)?await m(this,D).call(this,r):Promise.resolve(r)}});y(this,"pause",()=>(_(this,T,!1),m(this,L)-1));y(this,"add",r=>{m(this,S)&&m(this,S).push(r)});_(this,S,r)}}F=new WeakMap,T=new WeakMap,S=new WeakMap,L=new WeakMap,D=new WeakMap;const tn=Object.freeze(Object.defineProperty({__proto__:null,ParallelTaskScheduling:G,ParallelTaskSchedulings:en,PausingSerialTasks:nn,SerialTaskScheduling:rn},Symbol.toStringTag,{value:"Module"}));function on(e,r=3,n=-4){let t="";const o=e.slice(0,r),a=e.slice(r,n).length,s=e.slice(n);for(let i=0;i<a;i++)t+="*";return o+t+s}function K(e){let r=0;for(let n=0;n<e.length;){r++;const t=e.codePointAt(n);n+=t>65535?2:1}return r}function se(e,r){let n=0;for(let t=0;t<e.length;){if(n===r){const a=e.codePointAt(t);return String.fromCodePoint(a)}n++;const o=e.codePointAt(t);t+=o>65535?2:1}}function an(e,r,n){n??(n=K(e));let t="";const o=K(e);for(let a=r;a<o&&a<n;a++)t+=se(e,a);return t}function sn(e){let r=e.length,n=0;for(;n<r;)e.charCodeAt(n)>255&&r++,n++;return r}function ln(e){const r=e.split("");let n=0;return r.forEach(t=>{n+=t.charCodeAt(0)}),n}function V(e){return e<=11?Math.random().toString(36).substring(2,2+e).padEnd(e,"0"):V(11)+V(e-11)}function cn(e){var r=0;return e.length<6||(/[0-9]/.test(e)&&r++,/[a-z]/.test(e)&&r++,/[A-Z]/.test(e)&&r++,/[\.|-|_]/.test(e)&&r++),r}function un(e){return/^(([1-9][0-9]*)|(([0]\.\d{1,2}|[1-9][0-9]*\.\d{1,2})))$/.test(e)}function mn(e,r=1){let n=Math.abs(r),t="";for(;n;)n%2===1&&(t+=e),n>1&&(e+=e),n>>=1;return t}function pn(e,r){if(!e&&!r)return 0;if(!e)return-1;if(!r)return 1;const n=e.split("."),t=r.split("."),o=Math.max(n.length,t.length);for(let a=0;a<o;a++){const s=~~n[a],i=~~t[a];if(s>i)return 1;if(s<i)return-1}return 0}function dn(e=""){if(e==="")return"";if(isNaN(Number(e)))return"无效金额字符";if(e.length>80)return"金额过大";const r=["零","壹","贰","叁","肆","伍","陆","柒","捌","玖"],n=["","拾","佰","仟"],t=["","万","亿","兆","京","垓","杼","穰","沟","涧","正","载","极","恒河沙","阿僧祇","那由它","不可思议","无量","大数","古戈尔"],o=["角","分","厘","毫","丝"];let a="",s="",i="",c="";/\./.test(e)?(i=e.split(".")[0],c=e.split(".")[1].slice(0,5),Array(...c).forEach((f,h)=>{f==="0"?s+=r[f]:s+=r[f]+o[h]}),s=s.replace(/零+/,"零"),s=s.replace(/零$/,"")):i=e,i=i.replace(/^0+/,"");const p=/(?=(\B)(\d{4})+$)/g,u=i.replace(p,",").split(","),d=u.length;return u.forEach((f,h)=>{let w="";if(/^0000$/.test(f))return a;const j=f.length;f=f.replace(/0+$/,""),Array(...f).forEach((P,H)=>{P==="0"?w+=r[P]:w+=r[P]+n[j-H-1]}),w=w.replace(/零+/,"零"),a+=w+t[d-h-1],a||(a="零")}),s?a+"元"+s:a+"元整"}function fn(e){return"1111100000".slice(5-e,10-e)}function gn(e=8,r="0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"){let n="";for(let t=e;t>0;--t)n+=r[Math.floor(Math.random()*r.length)];return n}const hn=Object.freeze(Object.defineProperty({__proto__:null,ascllSum:ln,checkPasswordLevel:cn,compareVersion:pn,digitUppercase:dn,encrypt:on,isFixed2Float:un,pointAt:se,pointLength:K,pointSlice:an,randomString:V,rate:fn,repeatStr:mn,strBytesLength:sn,uuid:gn},Symbol.toStringTag,{value:"Module"})),yn=Object.freeze(Object.defineProperty({__proto__:null},Symbol.toStringTag,{value:"Module"}));function ie(e){const r={};return e.replace(/([^?&=]+)=([^&]+)/g,(n,t,o)=>r[t]=o),r}function le(e){return Object.keys(e).map(r=>`${r}=${e[r]}`).join("&")}function bn(e){const r=new URL("http://0.0.0.0"+e);return{fullPath:r.href.replace(r.origin,""),path:r.pathname,query:ie(r.search),hash:r.hash.slice(1)}}function xn(e){let r="";const{path:n,query:t,hash:o}=e;return n&&(r+=n),Object.keys(t).length>0&&(r+=`?${le(t)}`),o&&(r+=`#${o}`),r}function vn(e,r){const n=r.lastIndexOf("./")+1,t=r.slice(0,n);if(t==="."){const s=e.lastIndexOf("/");return e.slice(0,s)+r.slice(n)}const o=t.split("/").length+1;return e.split("/").slice(0,-o).join("/")+r.slice(n)}const _n=Object.freeze(Object.defineProperty({__proto__:null,parseQuery:ie,parseUrl:bn,resolvePath:vn,stringifyQuery:le,stringifyUrl:xn},Symbol.toStringTag,{value:"Module"}));function ce(e=""){const r={},n=/<([a-z]+)\s*[^>]*>/,t=e.match(n);t&&(r.tag=t[1]);const o=/\s*([^=\s]+)\s*=\s*['"]?([^'"\s]+)['"]?/g;let a;const s={};for(;a=o.exec(e);)s[a[1]]=a[2];r.attrs=s;const i=/>(.*)<\/[a-z]+>/s,c=e.match(i);if(c){const p=c[1].trim();p.length>0&&(r.children=p.split(`
`).map(u=>n.test(u)?ce(u):u))}return r}function wn(e){return e.replace(/<[^>]+>/g,"")}const kn=Object.freeze(Object.defineProperty({__proto__:null,removeXMLTag:wn,stringToVirtualDOM:ce},Symbol.toStringTag,{value:"Module"}));function Tn(){const e={keys:[],body:{}},r=Object.assign({"/core/utils/array.ts":We,"/core/utils/async.ts":He,"/core/utils/browser.ts":qe,"/core/utils/class.ts":ze,"/core/utils/color.ts":$e,"/core/utils/date.ts":Ye,"/core/utils/dom.ts":Ke,"/core/utils/encoding.ts":Ve,"/core/utils/file.ts":Xe,"/core/utils/generator.ts":Ge,"/core/utils/image.ts":Qe,"/core/utils/judge.ts":Ze,"/core/utils/math.ts":Je,"/core/utils/number.ts":er,"/core/utils/object.ts":rr,"/core/utils/optimize.ts":nr,"/core/utils/queue.ts":tr,"/core/utils/string.ts":or,"/core/utils/type.ts":ar,"/core/utils/url.ts":sr,"/core/utils/xml.ts":ir});for(const n in r){const t=Oe(n);e.keys.push(t),e.body[t]=r[n]}return e}function Sn(){const e=Object.assign({"/core/utils/array.ts":Le,"/core/utils/async.ts":Pe,"/core/utils/browser.ts":ye,"/core/utils/class.ts":cr,"/core/utils/color.ts":gr,"/core/utils/date.ts":wr,"/core/utils/dom.ts":Rr,"/core/utils/encoding.ts":Wr,"/core/utils/file.ts":$r,"/core/utils/generator.ts":be,"/core/utils/image.ts":Kr,"/core/utils/judge.ts":xe,"/core/utils/math.ts":Ee,"/core/utils/number.ts":Me,"/core/utils/object.ts":ve,"/core/utils/optimize.ts":Jr,"/core/utils/queue.ts":tn,"/core/utils/string.ts":hn,"/core/utils/type.ts":yn,"/core/utils/url.ts":_n,"/core/utils/xml.ts":kn}),r={};for(const n in e){const t=n.split("/").pop().replace(".ts","");r[t]=e[n]}return r}const Hn=e=>{const r=Y(Te),[n,t]=q([]),[o,a]=q({name:"",content:""}),s=re(Tn,[]);async function i(l){const{keys:g,body:v}=await s;!n.length&&t(g);const x=g.find(M=>M===l)||g[0];let C=v[x];r.state.codeLanguage==="js"&&(C=Fe(C)),a({name:x,content:C})}const c=fe(),[p,u]=q(!0);E(()=>{if(p){u(!1);return}const l=c.current.path+".ts";i(l)},[r.state.codeLanguage]);const d=re(()=>{const l=de(o.content,{sourceType:"module",plugins:["typescript"]});function g(k){const x={start:null,title:null};if(!k)return x;const C=k[k.length-1],{type:M,value:O,loc:B}=C;if(x.start=B.start.line,M==="CommentBlock"){const R=O.match(/\*(.)+(\n|\r\n)/);if(!R)return x;x.title=R[0].replace(/\*/g,"").trim()}else x.title=O.replace(/\/\//,"").trim();return x}const v=[];for(const k of l.program.body)if(k.type==="ExportNamedDeclaration"){if(["FunctionDeclaration","ClassDeclaration"].includes(k.declaration.type)){const{loc:x,declaration:C,leadingComments:M}=k,{start:O,end:B}=x,{start:R,title:$}=g(M);v.push({start:O.line,end:B.line,name:C.id.name,title:$,commentStart:R})}}else if(k.type==="FunctionDeclaration"){const{loc:x,id:C,leadingComments:M}=k,{start:O,end:B}=x,{start:R,title:$}=g(M);v.push({start:O.line,end:B.line,name:C.name,title:$,commentStart:R})}return v},[o.content]);E(()=>c.monitor(async(l,g)=>{if(!l.path.startsWith(e.path))return;const v=l.path+".ts";i(v)}),[]),E(()=>{if(!d.length)return;const l=c.current.query.name;if(!l)return;const g=d.find(v=>v.name===l);g&&setTimeout(()=>{h(g.commentStart)})},[d]);const f=ne();function h(l){const g=f.current.getEl().getElementsByClassName("row-num")[0].childNodes;for(const v of g)if(v.getElementsByTagName("label")[0].textContent===l+""){ke(v);break}}const w=()=>b("ul",{className:N.navigation},...n.map(l=>{const g=l.split("/")[2].replace(".ts","");return b("li",null,b(ge,{to:l.split(".")[0]},g))})),j=Y(Se);E(()=>{n.length&&j.dispatch({type:"menuSet",payload:w()})},[n]),E(()=>()=>{j.dispatch({type:"menuClear"})},[]),E(()=>{const l="$utils";return window[l]=Sn(),()=>{delete window[l]}},[]);const[P,H]=q(!1),Q=ne(),ue=(()=>{const l=o.name.split("/")[2];return l?"$utils."+l.replace(".ts",""):"$utils."})(),Z=Y(Ce);return E(()=>{const l=Symbol("utilsConsole"),g={id:l,btn:b("div",{onclick:()=>H(!0)},"C"),layer:2};return Z.dispatch({type:"btnAdd",payload:g}),()=>{Z.dispatch({type:"btnRemove",payload:l})}},[]),b(we,{className:N.pageUtils},b("aside",null,w()),b("section",{className:N.content},b(_e,{ref:f,value:o.content,lines:d})),b("aside",{className:N.outline},b("ul",null,...d.map(l=>b("li",{className:"text-ellipsis",onclick:()=>{h(l.commentStart||l.start),c.replace({path:o.name.replace(".ts",""),query:{name:l.name}})}},l.title||l.name))),b("div",{className:N.total},"total: ",d.length)),b(je,{open:P,onClose:()=>{Q.current.clear(),H(!1)},style:"width: 500px"},b(Re,{ref:Q,value:ue})))};export{Hn as default};
